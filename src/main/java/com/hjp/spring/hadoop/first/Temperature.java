...
import com.hjp.spring.hadoop.first.WordCount.IntSumReducer;
import com.hjp.spring.hadoop.first.WordCount.TokenizerMapper;
...
public class Temperature {
    ...
    static class TempReducer extends
        ...
        public static void main(String[] args) throws Exception {
            ...
            //输入路径
            String dst = "hdfs://master:9000/data/input/ncdc/sample.txt";
            //输出路径，必须是不存在的，空文件加也不行。
            String dstOut = "hdfs://master:9000/data/output/temperature_result";
        	
        	Configuration conf = new Configuration();
    		Job job = Job.getInstance(conf, "temperature_mr");
